...
module.exports.run = async function ({ event, api, args }) {    
    ...
    if (!mention[0]) return api.sendMessage("╔══🤖•𝐑𝐀𝐊𝐈𝐁-𝐁𝐎𝐓•𝟎𝟎𝟕🤖══╗\n\n[•১ জন কে ট্যাগ করতে হবে•]\n\n╚══🤖•𝐑𝐀𝐊𝐈𝐁-𝐁𝐎𝐓•𝟎𝟎𝟕🤖══╝", threadID, messageID);
    else {
        const one = senderID, two = mention[0];
        return makeImage({ one, two }).then(path => api.sendMessage({ body: "╔══✅•𝐑𝐀𝐊𝐈𝐁-𝐁𝐎𝐓•𝟎𝟎𝟕✅══╗\n\n[•এই নেও তোমার লগো 🤖•]\n\n╚══✅•𝐑𝐀𝐊𝐈𝐁-𝐁𝐎𝐓•𝟎𝟎𝟕✅══╝◦", attachment: fs.createReadStream(path) }, threadID, () => fs.unlinkSync(path), messageID));
    }
                                }